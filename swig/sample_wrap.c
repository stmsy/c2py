...
extern "C" {
#endif
SWIGINTERN int Swig_var_dvar_set(PyObject *_val) {
  {
    double val;
...
SWIGINTERN PyObject *Swig_var_dvar_get(void) {
  PyObject *pyobj = 0;
...
# endif
  ...
  Py_DECREF(globals);
  SWIG_addvarlink(globals, "dvar", Swig_var_dvar_get, Swig_var_dvar_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
